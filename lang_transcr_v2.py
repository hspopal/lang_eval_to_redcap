...
lang_trans = pd.read_excel(file, 'Lang transcriptions', header=None, encoding='utf-8')
#lang_trans = lang_trans.encode('ascii', 'ignore')
...
if lang_trans.empty:
    ...
    if trans_clear.empty:
        ...
        single_test.to_csv(work_dir + 'lang_trans_test.csv', encoding='utf-8')
